...
import com.example.adminfoodexpress.databinding.PendingOrdersItemBinding

class PendingOrderAdapter(
    private val context: Context,
    private val customerNames: MutableList<String>,
    private val totalPay: MutableList<String>,
    ...
    inner class PendingOrderViewHolder(private val binding: PendingOrdersItemBinding) :
        ...
        fun bind(position: Int) {
            binding.apply {
                ...
                //send quantity
                pendingOrderTotalPay.text = totalPay[position]
